        ...
        <div class="container">
            ...
            <div class="row justify-content-md-center">
                <div class="col-8">
                    ...
                    <a href="index.php?id=<?php echo $identificacion ?>" type = "button">Actualizar</a>
                            ...
                            <?php foreach ($res as $val) { ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-primary" target="_black" href="<?php echo 'http://' . $_SERVER['HTTP_HOST'] . '/Proyecto/php/Archivos/' . $val['url']; ?>" >Ver Archivo pagina</a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
