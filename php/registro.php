...
$barrio=$_POST['barrio'];
$telefono_celular=$_POST['telefono/celular'];
$rh=$_POST['rh'];
$genero=$_POST['genero'];
...
$sql="INSERT INTO `estudiantes` (`identificacion`, `nombres`, `apellidos`, `f_matricula`, `no_matricula`, `folio`, `direccion`, `barrio`, `telefono/celular`, `rh`, `genero`, `dto_residencia`, `mpio_residencia`, `f_nacimiento`, `departamento`, `municipio`, `calendario`, `zona`, `institución`, `sede`, `institucion_bienestar`, `capacidad`, `discapacidad`, `v_conflicto`, `dpto_procedencia`, `mpio_procedencia`, `etnia`, `resguardo`, `sisben`, `estrato`, `eps`, `ars`, `situacion_matricula`, `grado`, `curso`, `jornada`, `nombre_a`,`tipo_documento`, `numero_documento`, `parentezco`, `residencia_a`, `dir_residencia`, `dir_laboral`, `tel_laboral`, `ceular_a`, `ocupacion`) VALUES ('$identificacion', '$nombres', '$apellidos', '$f_matricula', '$no_matricula', '$folio','$direccion', '$barrio', '$telefono_celular', '$rh', '$genero', '$dto_residencia', '$mpio_residencia', '$f_nacimiento', '$departamento', '$municipio', '$calendario', '$zona', '$institución', '$sede', '$institucion_bienestar', '$capacidad', '$discapacidad', '$v_conflicto', '$dpto_procedencia', '$mpio_procedencia', '$etnia', '$resguardo', '$sisben', '$estrato', '$eps', '$ars', '$situacion_matricula', '$grado','$curso', '$jornada','$nombre_a','$tipo_documento', '$numero_documento', '$parentezco', '$residencia_a', '$dir_residencia', '$dir_laboral', '$tel_laboral', '$ceular_a', '$ocupacion')";

$resul = mysqli_query($conectar, $sql) or trigger_error("Query Failed! SQL - ERROR:" .mysqli_error($conectar), E_USER_ERROR);


header('location: ../assets/html/administracion/matricula.html');
